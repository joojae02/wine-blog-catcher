...
export type BlogsReadBlogsResponse = BlogsPublic

export type BlogsCreateBlogData = {
  requestBody: BlogCreate
}

export type BlogsCreateBlogResponse = BlogPublic

export type BlogsReadBlogData = {
  id: string
}

export type BlogsReadBlogResponse = BlogPublic

export type BlogsUpdateBlogData = {
  id: string
  requestBody: BlogUpdate
}

export type BlogsUpdateBlogResponse = BlogPublic
...
export type ProxyProxyImageResponse = unknown
